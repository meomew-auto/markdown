...
| Ý tưởng chính | [Ý tưởng chính](./20260515_02_shared-iterations-tham-so-cong-thuc.md#1-ý-tưởng-chính) |
| Khi nào dùng thực tế | [Khi nào dùng thực tế](./20260515_02_shared-iterations-tham-so-cong-thuc.md#11-khi-nào-dùng-thực-tế) |
| Core chạy như nào | [Core chạy như nào](./20260515_02_shared-iterations-tham-so-cong-thuc.md#12-core-chạy-như-nào) |
| Bảng tham số | [Bảng tham số](./20260515_02_shared-iterations-tham-so-cong-thuc.md#2-bảng-tham-số-tiếng-việt) |
| Công thức nền | [Công thức nền](./20260515_02_shared-iterations-tham-so-cong-thuc.md#3-công-thức-nền) |
| Khác gì với `per-vu-iterations` | [So sánh per-vu](./20260515_02_shared-iterations-tham-so-cong-thuc.md#4-khác-gì-với-per-vu-iterations) |
| Demo `dropped_iterations` do `maxDuration` | [Dropped iterations](./20260515_02_shared-iterations-tham-so-cong-thuc.md#demo-dropped-iterations-do-maxduration) |
| Demo VU nhanh lấy thêm việc | [Demo phân phối](./20260515_02_shared-iterations-tham-so-cong-thuc.md#5-demo-phân-phối-iteration) |
| Đếm mỗi VU chạy bao nhiêu vòng | [Demo đếm từng VU](./20260515_02_shared-iterations-tham-so-cong-thuc.md#51-demo-đếm-từng-vu-nhanhchậm) |
| QuickPizza 2 requests / iteration | [Demo QuickPizza](./20260515_02_shared-iterations-tham-so-cong-thuc.md#6-demo-quickpizza-2-requests--iteration) |
| Worked example QuickPizza | [Worked example](./20260515_03_shared-iterations-quickpizza-two-requests-worked-example.md) |
| Các loại metric và công thức | [k6 metrics căn bản](./20260520_00_k6-metrics-types-builtins-core-guide.md) |
